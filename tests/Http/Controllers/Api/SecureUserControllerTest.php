...
class SecureUserControllerTest extends TestCase
{
    use RefreshDatabase;
    use WithFaker;
    ...
    public function users_can_be_retrieve()
    {
        ...
        $response = $this->get('api/system/secure/user?page=2&order-by=name&order-in=ASC');
    ...
    public function a_user_can_be_retrieve()
    {
        ...
        $response = $this->get('api/system/secure/user/'.$user->id);
        $response->assertStatus(200);
        $response->assertJsonStructure(
            [
                'id',
    ...
    public function a_user_can_be_created()
    {
        ...
        $response = $this->post('api/system/secure/user', $this->mockUserData());
    ...
    public function a_user_can_be_updated()
    {
        ...
        $response = $this->put('api/system/secure/user/'.$user->id, $this->mockUserData());
        $response->assertJsonStructure([
            'profile_picture',
            'roles',
        ]);
    ...
    public function a_user_can_be_deleted()
    {
        $user = User::factory()
            ...
            ->create();
        $total_users = User::all()->count();
        $response = $this->delete('api/system/secure/user/'.$user->id);
        $this->assertEquals(($total_users - 1), User::all()->count());
    ...
    public function users_can_be_search()
    {
        ...
        $response = $this->get('api/system/secure/user?page=1&order-by=name&order-in=ASC&email='.$user->email);
        $response->assertStatus(200);
        $response->assertJsonStructure(
            [
                'meta' => [
